            ...
            <form method="POST" action="{{ route('mahasiswa.store') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <textarea id="judul_skripsi" name="judul_skripsi" rows="3" required
                        class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">{{ old('judul_skripsi') }}</textarea>
                ...
                <div>
                    ...
                    <select id="profil_lulusan" name="profil_lulusan"
                        ...
                        <option value="Ilmuwan" {{ old('profil_lulusan') == 'Ilmuwan' ? 'selected' : '' }}>Ilmuwan</option>
                        <option value="Wirausaha" {{ old('profil_lulusan') == 'Wirausaha' ? 'selected' : '' }}>Wirausaha</option>
                        <option value="Profesional" {{ old('profil_lulusan') == 'Profesional' ? 'selected' : '' }}>Profesional</option>
                    </select>
                ...
                <div>
                    ...
                    <select id="penjurusan" name="penjurusan"
                        ...
                        <option value="Sistem Informasi" {{ old('penjurusan') == 'Sistem Informasi' ? 'selected' : '' }}>Sistem Informasi</option>
                        <option value="Perekayasa Perangkat Lunak" {{ old('penjurusan') == 'Perekayasa Perangkat Lunak' ? 'selected' : '' }}>Perekayasa Perangkat Lunak</option>
                        <option value="Perekayasa Jaringan Komputer" {{ old('penjurusan') == 'Perekayasa Jaringan Komputer' ? 'selected' : '' }}>Perekayasa Jaringan Komputer</option>
                        <option value="Sistem Cerdas" {{ old('penjurusan') == 'Sistem Cerdas' ? 'selected' : '' }}>Sistem Cerdas</option>
                    </select>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea id="keterangan_prioritas" name="keterangan_prioritas" rows="3"
                                ...
                                class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50">{{ old('keterangan_prioritas') }}</textarea>
