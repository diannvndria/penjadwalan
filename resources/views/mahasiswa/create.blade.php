        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-blue-50 to-indigo-50">
                <div class="flex items-center">
                    ...
                    <h3 class="font-semibold text-gray-800">Form Tambah Mahasiswa Baru</h3>
                </div>
            </div>
                    ...
                    <div>
                        ...
                        <select id="id_dospem" name="id_dospem" required
                            ...
                            @foreach($dosens as $dosen)
                                <option value="{{ $dosen->nip }}" {{ old('id_dospem') == $dosen->nip ? 'selected' : '' }}>
                                    {{ $dosen->nama }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea id="keterangan_prioritas" name="keterangan_prioritas" rows="3"
                                ...
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:border-yellow-500 focus:ring-2 focus:ring-yellow-500 focus:ring-opacity-50">{{ old('keterangan_prioritas') }}</textarea>
