            ...
            <form method="POST" action="{{ route('mahasiswa.update', $mahasiswa->id) }}" class="space-y-4">
                ...
                <div>
                    ...
                    <textarea id="judul_skripsi" name="judul_skripsi" rows="3" required
                        class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{ old('judul_skripsi', $mahasiswa->judul_skripsi) }}</textarea>
