                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea id="keterangan_prioritas" name="keterangan_prioritas" rows="3"
                                ...
                                class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">{{ old('keterangan_prioritas') }}</textarea>
