...
@section('content')
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        <div class="bg-gradient-to-r from-indigo-600 to-purple-600 px-8 py-6 rounded-t-xl">
            ...
            <p class="text-indigo-100 text-sm mt-1">Lengkapi formulir untuk membuat jadwal sidang mahasiswa</p>
        </div>
        ...
        <div class="p-8">
            ...
            <form method="POST" action="{{ route('munaqosah.store') }}" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <select id="id_mahasiswa" name="id_mahasiswa" required
                        ...
                        @foreach($mahasiswasSiapSidang as $mahasiswa)
                            <option value="{{ $mahasiswa->nim }}" {{ old('id_mahasiswa') == $mahasiswa->nim ? 'selected' : '' }}>
                ...
                <div>
                    ...
                    <select id="id_ruang_ujian" name="id_ruang_ujian" required
                        ...
                        @foreach($ruangUjians as $ruang)
                            <option value="{{ $ruang->id }}" {{ old('id_ruang_ujian') == $ruang->id ? 'selected' : '' }}>
                ...
                <div class="mt-4">
                    ...
                    <select id="id_penguji_utama" name="id_penguji_utama"
                        ...
                        <option value="">Tidak Ada</option>
                        @foreach($pengujis as $penguji)
                            <option value="{{ $penguji->nip }}" {{ old('id_penguji_utama') == $penguji->nip ? 'selected' : '' }}>{{ $penguji->nama }}</option>
                        @endforeach
                    </select>
