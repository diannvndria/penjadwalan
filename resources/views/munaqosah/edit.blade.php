            ...
            <form method="POST" action="{{ route('munaqosah.update', $munaqosah->id) }}" class="space-y-6">
                ...
                <div>
                    ...
                    <select id="id_penguji1" name="id_penguji1" required
                        ...
                        @foreach($pengujis as $penguji)
                            <option value="{{ $penguji->nip }}" {{ old('id_penguji1', $munaqosah->id_penguji1) == $penguji->nip ? 'selected' : '' }}>{{ $penguji->nama }}</option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select id="id_penguji2" name="id_penguji2"
                        ...
                        @foreach($pengujis as $penguji)
                            <option value="{{ $penguji->nip }}" {{ old('id_penguji2', $munaqosah->id_penguji2) == $penguji->nip ? 'selected' : '' }}>{{ $penguji->nama }}</option>
                        @endforeach
                    </select>
